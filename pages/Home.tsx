...
import { Smartphone, Headphones, Watch, Laptop, BatteryCharging, Zap, Truck, ShieldCheck, CreditCard, Flame, Clock, ArrowRight, Star, Heart, TrendingUp, ThumbsUp, MapPin, Tablet } from 'lucide-react';
import { useShop } from '../context/ShopContext';
import { Link, useNavigate } from 'react-router-dom';
import { ProductCard } from '../components/ProductCard';

export const Home: React.FC = () => {
  const { recentlyViewed, user } = useShop();
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-20 font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2. VALUE PROPOSITION */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 -mt-12 md:-mt-16 relative z-20 mb-20">
            {[
                ...
                <div key={i} className="bg-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 flex flex-col items-center text-center border border-gray-100 hover:-translate-y-2 transition-transform duration-300 group">
        ...
        <div className="mb-20">
          <div className="flex justify-between items-end mb-8">
             ...
             <Link to="/categories" className="text-primary font-bold text-sm flex items-center gap-1 hover:text-secondary transition-colors px-4 py-2 bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md">
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden text-white shadow-2xl">
             ...
             <div className="absolute top-0 right-0 -mr-32 -mt-32 w-[600px] h-[600px] bg-primary/30 rounded-full blur-[100px] mix-blend-screen"></div>
             <div className="absolute bottom-0 left-0 -ml-32 -mb-32 w-[500px] h-[500px] bg-secondary/20 rounded-full blur-[80px] mix-blend-screen"></div>
             ...
             <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                <div className="w-full md:w-5/12 flex justify-center">
                   <div className="relative group">
                      ...
                      <img src="https://picsum.photos/seed/103/500/500" className="w-80 h-80 md:w-[450px] md:h-[450px] object-contain relative z-10 drop-shadow-2xl hover:scale-105 transition-transform duration-500" alt="Deal Product"/>
                   </div>
                </div>
                ...
                <div className="w-full md:w-7/12 space-y-8 text-center md:text-left">
                   ...
                   <div className="space-y-4">
                       <h2 className="text-4xl md:text-6xl font-black leading-tight tracking-tight">Samsung Galaxy <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">S24 Ultra</span></h2>
                   ...
                   <div className="flex flex-wrap items-center justify-center md:justify-start gap-8 bg-white/5 p-6 rounded-2xl border border-white/5 backdrop-blur-sm w-fit mx-auto md:mx-0">
                      <div className="flex flex-col">
                         <span className="text-sm text-gray-400 font-bold line-through mb-1">450.000 KWD</span>
                         <span className="text-5xl font-black text-white tracking-tight">390 <span className="text-xl text-secondary">KWD</span></span>
                      </div>
       ...
       <div className="my-24">
           <div className="bg-primary rounded-[2.5rem] p-10 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-2xl">
              ...
              <div className="relative z-10">
                 ...
                 <img src="https://picsum.photos/seed/201/500/500" className="w-72 md:w-96 object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500 -rotate-12 hover:rotate-0" alt="Audio"/>
              </div>
           </div>
       </div>
